...
- NPC population scaling 1/5/20/30 реально ограничивает дневной объём ликвидности, а не только возвращается как справочная цифра.
- Неуспешные NPC операции не расходуют дневную квоту.
