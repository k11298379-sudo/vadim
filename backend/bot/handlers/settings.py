...
def format_settings_text(canteen_on: bool, currency_on: bool, coins: int) -> str:
    ...
    return (
        ...
        "<i>Разблокирует игры «Дурак» и «21 Очко» (Блэкджек), команды <code>/cash</code> и <code>/work</code>, ставки на монеты и рейтинг игроков в Mini App.</i>\n\n"
...
ECOSYSTEM_GUIDE_TEXT = (
    ...
    "• <b>«Дурак»:</b> классическая игра на 36 карт (с ботом или онлайн с одноклассниками, банк забирает победитель).\n"
    "• <b>«21 Очко» (Блэкджек):</b> игра против дилера! Соберите 21 очко или больше дилера без перебора. Натуральный блэкджек оплачивается 3 к 2, доступно удвоение (Double Down).\n"
