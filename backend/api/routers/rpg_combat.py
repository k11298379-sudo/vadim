...
async def slash_creep_wave_endpoint(
    ...
    if victory:
        ...
        return {
            ...
            "enemy_name": enemy_name,
            "enemy_icon": enemy_icon,
            "description": f"⏳ Бой затянулся ({rounds} раундов)! Босс выстоял с {max(0, e_hp):,} HP. У вас осталось {max(0, hero_hp):,} HP.",
        ...
        return {
            ...
            "enemy_name": enemy_name,
            "enemy_icon": enemy_icon,
            "description": f"💀 Герой пал на {rounds} раунде боя! Повысьте броню и здоровье!",
            "hero_hp_left": 0,
            "hero_hp_max": stats["hp_max"],
            "enemy_hp_left": max(0, e_hp),
            "enemy_hp_max": enemy_hp,
