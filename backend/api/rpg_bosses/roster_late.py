...
LATE_BOSSES: Dict[str, Any] = {
    "terrorblade": {
        ...
        "icon": "😈",
        "desc": "[РАНГ 11: 12 МЛРД ХП!] Владыка отражений Инферно. Метаморфоза дальнего боя и разрыв души Sunder!",
        "max_hp": 12000000000,
        "atk_min": 9500,
        "atk_max": 12500,
        "defense": 570,
    ...
    "invoker_boss": {
        ...
        "icon": "🧙",
        "desc": "[РАНГ 12: 42 МЛРД ХП!] Магический абсолют. Хаос-метеоры, радиальный EMP и санстрайк сквозь измерения!",
        "max_hp": 42000000000,
        "atk_min": 15000,
        "atk_max": 19500,
        "defense": 700,
    ...
    "chaos_knight": {
        ...
        "icon": "🐎",
        "desc": "[РАНГ 13: 150 МЛРД ХП!] Воплощение первородного хаоса. Непредсказуемый крит и армия иллюзий Phantasm!",
        "max_hp": 150000000000,
        "atk_min": 23000,
        "atk_max": 30000,
        "defense": 860,
    ...
    "dark_tormentor": {
        ...
        "icon": "🪐",
        "desc": "[РАНГ 14: 550 МЛРД ХП!] Сверхплотная сингулярная сущность. Отражает 50% урона и накладывает барьеры!",
        "max_hp": 550000000000,
        "atk_min": 36000,
        "atk_max": 48000,
        "defense": 1050,
    ...
    "enigma": {
        ...
        "icon": "🌌",
        "desc": "[ФИНАЛЬНЫЙ БОСС: 1.2 КВАДРИЛЛИОНА ХП!] Месяц непрерывной битвы! Владыка гравитации затягивает сущее в Черную Дыру!",
