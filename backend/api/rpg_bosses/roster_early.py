...
EARLY_BOSSES: Dict[str, Any] = {
    ...
    "roshan": {
        ...
        "icon": "🧌",
        "desc": "[РАНГ 7: 50 МЛН ХП!] Легендарный хранитель Аегиса и Сыра. Ударная волна Slam и свирепый рев!",
        "max_hp": 50000000,
        "atk_min": 1500,
        "atk_max": 1900,
        "defense": 200,
    ...
    "tidehunter": {
        ...
        "icon": "🐙",
        "desc": "[РАНГ 8: 80 МЛН ХП!] Владыка затонувших глубин. Вызывает щупальца Ravage и снижает урон якорем!",
        "max_hp": 80000000,
        "atk_min": 2400,
        "atk_max": 3000,
        "defense": 260,
    ...
    "sf_boss": {
        ...
        "icon": "🔥",
        "desc": "[РАНГ 9: 125 МЛН ХП!] Собиратель душ. Реквием Душ и тройной койл стирают неподготовленных героев!",
        "max_hp": 125000000,
        "atk_min": 3000,
        "atk_max": 3800,
        "defense": 320,
    ...
    "necrophos": {
        ...
        "icon": "🧙‍♂️",
        "desc": "[РАНГ 10: 180 МЛН ХП!] Владыка мора. Пассивная аура Heartstopper непрерывно сжигает здоровье героев!",
        "max_hp": 180000000,
        "atk_min": 3700,
        "atk_max": 4600,
        "defense": 380,
