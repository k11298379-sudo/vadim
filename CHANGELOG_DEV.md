...
11. **Настройки бота как кнопка (вместо команды)**
   - Настройки доступны как через постоянную Reply-кнопку «⚙️ Настройки» в главном меню для всех учеников, так и через Inline-кнопку «⚙️ Настройки бота» в панели управления администратора.
   - Из настроек добавлена кнопка возврата «🔙 В панель управления», восстанавливающая админ-панель.
...
- `backend/bot/handlers/settings.py` & `backend/bot/keyboards/admin_kb.py`:
  - Кнопка «⚙️ Настройки бота» в панели администратора с возможностью возврата назад (`admin_menu_back`).
  - Сохранение кнопки «⚙️ Настройки» в основном меню для всех учеников.
