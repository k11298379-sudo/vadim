  ...
  function renderGames() {
    ...
    container.innerHTML = `
      ...
      <div class="space-y-3">
        ...
        ${isTesterUser ? `<a href="/app/natbirzha" onclick="window.prepareNatbirzhaNavigation?.(event)" class="block p-3 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-emerald-600 text-white shadow-md active:scale-98 transition-all cursor-pointer">
          <div class="flex items-center justify-between">
